/**
 * 知识库分类树映射（独立模块，务必用动态 import 加载）。
 *
 * 不要静态 import 到主包：minify 后短函数名曾与 React 运行时（Cd/wd/Od/Sd）冲突，
 * 导致 category/list 返回 5 条却 mappedCount=0。
 */
